...
REM ----------------------------------------------------------------------
REM
REM  Last updated 3/13/2004 ($Id: pear.bat,v 1.1 2008/10/16 10:57:47 Admin Exp $ is not replaced if the file is binary)
...
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\WebServers\home\localhost\www\pear\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\WebServers\home\localhost\www\pear"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\WebServers\usr\local\php\cli\php.exe"
