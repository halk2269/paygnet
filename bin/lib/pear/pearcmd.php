...
// +----------------------------------------------------------------------+
//
// $Id: pearcmd.php,v 1.1 2008/10/16 10:57:48 Admin Exp $

ob_end_clean();
/**
 * @nodep Gtk
 */
if ('D:\WebServers\home\localhost\www\pear\pear' != '@'.'include_path'.'@') {
    ini_set('include_path', 'D:\WebServers\home\localhost\www\pear\pear');
}
