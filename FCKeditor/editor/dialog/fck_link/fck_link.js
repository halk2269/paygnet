...
function GetImageSize (url)
{
	...
	if (FileType == '.jpg' | FileType == '.png' | FileType == 'jpeg' | FileType == '.gif')
	{
		...
		{
			this.onload = null ;
			document.getElementById('txtPopupWidth').value  = oImageOriginal.width + 20;
			document.getElementById('txtPopupHeight').value = oImageOriginal.height + 20;
		}
		oImageOriginal.src = url;
	}
