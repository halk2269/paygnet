...
FCKeditor.prototype._GetIFrameHtml = function()
{
	...
	if (this.Prefix) sLink += ('&Prefix=' + escape(this.Prefix)) ;
	if (this.SID) sLink += ('&SID=' + escape(this.SID)) ;
	
	return '<iframe id="myframe" src="' + sLink + '" width="' + this.Width + '" height="' + this.Height + '" frameborder="no" scrolling="no" name="myframe"></iframe>' ;
}
